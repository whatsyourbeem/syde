...
const TiptapViewer = dynamic(() => import("@/components/common/tiptap-viewer"), { ssr: false, loading: () => <div className="h-24 bg-muted/20 animate-pulse rounded-md w-full"></div> });
