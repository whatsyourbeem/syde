...
export default async function ClubPage() {
  ...
  const { data: clubs, error: clubsError } = await supabase
    .from("clubs")
    .select(
      "*, owner_profile:profiles!clubs_owner_id_fkey(avatar_url, bio, full_name, id, link, tagline, updated_at, username, certified), member_count:club_members(count), club_members(user_id, profiles(*))"
    )
