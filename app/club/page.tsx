...
export default async function ClubPage() {
  ...
  const { data: clubs, error: clubsError } = await supabase
    .from("clubs")
    .select(
      "*, owner_profile:profiles!clubs_owner_id_fkey(id, username, full_name, avatar_url, tagline, bio, link, tags, contact_email, github_username, twitter_username, instagram_username, updated_at, certified), member_count:club_members(count), club_members(user_id, profiles(id, username, full_name, avatar_url, tagline, certified, bio, link, tags, contact_email, github_username, twitter_username, instagram_username, updated_at))"
    )
