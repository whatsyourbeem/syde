        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="sm:max-w-[337px] p-[25px] gap-4 rounded-[10px] border-[0.909091px] border-black/10 shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]">
                <DialogHeader className="p-0 gap-2 items-start">
                    <DialogTitle className="text-[18px] font-semibold leading-[28px] tracking-[-0.439453px] text-sydeblue text-start">
                        {title}
                    </DialogTitle>
                ...
                <DialogFooter className="flex flex-row justify-end items-center gap-2 mt-2 p-0">
                    ...
                    <Button
                        variant="outline"
                        onClick={onClose}
                        className="w-[81.82px] h-[35.99px] p-[8px_16px] border-[0.909091px] border-black/10 rounded-[12px] bg-white text-sydeblue text-[14px] font-medium leading-[20px] hover:bg-gray-50"
                    >
                        돌아가기
                    </Button>
                    ...
                    <Button
                        onClick={onConfirm}
                        disabled={loading}
                        className="w-[152px] h-[35.99px] p-[8px_16px] bg-sydeblue rounded-[12px] text-white text-[14px] font-medium leading-[20px] hover:bg-sydeblue/90"
                    >
