...
export function ShowcaseHeader() {
  return (
    <div className="w-full border-b border-[#B7B7B7]/50 bg-white">
      <div className="max-w-6xl mx-auto h-[120px] flex flex-col justify-center items-center px-4 py-8 gap-4 box-border">
        <div className="flex flex-col justify-center items-center gap-[10px] w-full">
          <h1 className="w-auto h-[29px] font-pretendard font-bold text-[24px] leading-[29px] flex items-center text-sydeblue
">
            Showcase
          </h1>
